...
Every NFL team gets one week off during the season, called its bye week. If two of your starters share that week, your lineup has two empty slots that Sunday. Nothing during a draft flags this — people discover it in September, when it is too late to fix. Draft Day catches it at the moment the pick is made.
